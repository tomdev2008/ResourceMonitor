...
public class QuerywebMain implements Runnable {
    ...
    public QuerywebMain(int intervalTime, String pidPath) {
        super();
    ...
    public void run() {
        ...
        while (true) {
            ...
            infoDao.insert_querywebinfo(info);
    ...
    public static void main(String[] args) {
        ...
        QuerywebMain querywebMain = new QuerywebMain(intervalTime, pidPath);
